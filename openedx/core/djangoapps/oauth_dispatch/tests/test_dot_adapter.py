...
class DOTAdapterTestCase(TestCase):
    ...
    def setUp(self):
        ...
        restricted_app = RestrictedApplication.objects.create(application=self.restricted_client)
        self.assertEqual(unicode(restricted_app), u"<RestrictedApplication '{name}'>".format(
    ...
    def test_get_restricted_access_token(self):
        ...
        self.assertEqual(readback_token.expires, datetime(1970, 1, 1, tzinfo=utc))
